...
## How It Works
### Basic Using Steps
Here will simply explain the basic idea about how it runs. However, the details will be showed in following parts. A diagram will also be uploaded in future update (just in one or two weeks).
