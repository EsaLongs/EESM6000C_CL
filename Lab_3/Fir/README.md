...
## How It Works
### Basic Using Steps
Here will simply explain the basic idea about how it runs. However, the details will be showed in following parts. A diagram shows the structure of this design.

![alt text](diagram.jpg)

In this design, you can access three places through AXI4-lite and stream interface: **Tap RAM**, **Data RAM**, and **Configrue Register**.
...
Finally, you write a special instruction to "Configrue Register" agiain and start the FIR, then it will gives you a sequence of results from the output stream interface (be integrated into core).
...
You can search parent directory to find the details of the multiplier and adder.
...
• **Note**: Taps must be written consecutively starting from `32'h3000_0000`.
...
• Contains three registers:
  ...
  2. **Tap Register** (`32'h1xxx_xxxx`):
     ◦ Specifies the number of taps (10-bit value).
  3. **Data Register** (`32'h2xxx_xxxx`):
     ◦ Specifies the number of input data points (10-bit value).

#### Access Data RAM
• **Interface**: AXI4-Stream  
• **Note**: Data is written dynamically during computation. Do not preload Data RAM.
