...
design_libs=(blk_mem_gen_v8_4_6 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tap_ram xil_defaultlib.glbl -o tap_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tap_ram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tap_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tap_ram_simv.daidir vcs_lib c.obj)
