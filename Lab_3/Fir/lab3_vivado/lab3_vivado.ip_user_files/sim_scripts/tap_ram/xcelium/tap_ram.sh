...
#
# Script generated by Vivado on Sun Mar 23 19:25:35 +0800 2025
...
#
# Usage        : tap_ram.sh
#                tap_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tap_ram.sh [-reset_run]
#                tap_ram.sh [-reset_log]
#                tap_ram.sh [-help]
#
...
#                script (type 'tap_ram.sh -help' for more information).
#
...
design_libs_elab="-libname blk_mem_gen_v8_4_6 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver blk_mem_gen_v8_4_6 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "tap_ram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tap_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tap_ram xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tap_ram -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tap_ram_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tap_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tap_ram.sh [-help]\n\
Usage: tap_ram.sh [-step]\n\
Usage: tap_ram.sh [-lib_map_path]\n\
Usage: tap_ram.sh [-reset_run]\n\
Usage: tap_ram.sh [-reset_log]\n\
Usage: tap_ram.sh [-keep_index]\n\
Usage: tap_ram.sh [-noclean_files]\n\n\
