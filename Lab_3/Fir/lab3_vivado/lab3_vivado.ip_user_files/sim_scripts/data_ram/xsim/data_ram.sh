...
#
# Script generated by Vivado on Sun Mar 23 19:25:43 +0800 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_10 -L c_reg_fd_v12_0_6 -L c_mux_bit_v12_0_6 -L c_shift_ram_v12_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_ram xil_defaultlib.data_ram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim data_ram -key {Behavioral:sim_1:Functional:data_ram} -tclbatch cmd.tcl -protoinst "protoinst_files/tap_ram.protoinst" -protoinst "protoinst_files/data_ram.protoinst" -log simulate.log
}
