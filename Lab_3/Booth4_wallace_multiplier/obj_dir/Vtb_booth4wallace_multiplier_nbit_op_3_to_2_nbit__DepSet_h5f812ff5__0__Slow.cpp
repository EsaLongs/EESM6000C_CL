...
VL_ATTR_COLD void Vtb_booth4wallace_multiplier_nbit_op_3_to_2_nbit___ctor_var_reset(Vtb_booth4wallace_multiplier_nbit_op_3_to_2_nbit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vtb_booth4wallace_multiplier_nbit_op_3_to_2_nbit___ctor_var_reset\n"); );
