...
# 1 "../../firmware/defs.h" 1
# 21 "../../firmware/defs.h"
# 1 "/opt/homebrew/Cellar/riscv-gnu-toolchain/main/lib/gcc/riscv64-unknown-elf/14.2.0/include/stdint.h" 1 3 4
# 11 "/opt/homebrew/Cellar/riscv-gnu-toolchain/main/lib/gcc/riscv64-unknown-elf/14.2.0/include/stdint.h" 3 4
# 1 "/opt/homebrew/Cellar/riscv-gnu-toolchain/main/lib/gcc/riscv64-unknown-elf/14.2.0/include/stdint-gcc.h" 1 3 4
# 34 "/opt/homebrew/Cellar/riscv-gnu-toolchain/main/lib/gcc/riscv64-unknown-elf/14.2.0/include/stdint-gcc.h" 3 4
...
# 12 "/opt/homebrew/Cellar/riscv-gnu-toolchain/main/lib/gcc/riscv64-unknown-elf/14.2.0/include/stdint.h" 2 3 4
# 22 "../../firmware/defs.h" 2
# 1 "/opt/homebrew/Cellar/riscv-gnu-toolchain/main/lib/gcc/riscv64-unknown-elf/14.2.0/include/stdbool.h" 1 3 4
...
void __attribute__ ( ( section ( ".mprjram" ) ) ) initfir() {
    ...
    (*(volatile uint32_t*)0x30000010) = 16;
...
# 41 "fir.c"
    ...
    while (i < 16) {
        outputsignal[i-2] = (*(volatile uint32_t*)0x30000044);
        (*(volatile uint32_t*)0x30000040) = i;
        i++;
    }
    outputsignal[16 -2] = (*(volatile uint32_t*)0x30000044);
    outputsignal[16 -1] = (*(volatile uint32_t*)0x30000044);

    uint32_t status = (*(volatile uint32_t*)0x30000000);

    (*(volatile uint32_t*)0x2600000c) = 0x005A0000 | (outputsignal[16 -1] << 24);
